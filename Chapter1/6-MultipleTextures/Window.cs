...
namespace LearnOpenTK
{
    public class Window : GameWindow
    {
        ...
        protected override void OnLoad()
        {
            ...
            // 示例使用了mix函数，这是个混合纹理的函数，最后一个参数用来指定混合的程度
            ...
            _computeTimer = new System.Threading.Timer(t => {
                if (minVal == 1.0m|| minVal == 0.0m)
                {
                    change = change * -1;
                    Debug.WriteLine($"change:{change}");
                }
                minVal = minVal + change;
                Debug.WriteLine($"minVal:{minVal}");
            }, null, 0, 100);
        }
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            _shader.SetFloat("mixVal", Convert.ToSingle(minVal));
            //int vertexMixLocation = GL.GetUniformLocation(_shader.Handle, "mixVal");
            //GL.Uniform1(vertexMixLocation, minVal);
