...
namespace LearnOpenTK
{
    ...
    public class Window : GameWindow
    {
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            _lightingShader.SetMatrix4("model", Matrix4.Identity, true);
            _lightingShader.SetMatrix4("view", _camera.GetViewMatrix(), true);
            _lightingShader.SetMatrix4("projection", _camera.GetProjectionMatrix(), true);

            _lightingShader.SetVector3("objectColor", new Vector3(1.0f, 0.5f, 0.31f));
            _lightingShader.SetVector3("lightColor", new Vector3(1.0f, 1.0f, 1.0f));//灯光色
            ...
            _lampShader.SetMatrix4("model", lampMatrix, true);
            _lampShader.SetMatrix4("view", _camera.GetViewMatrix(), true);
            _lampShader.SetMatrix4("projection", _camera.GetProjectionMatrix(), true);

            GL.DrawArrays(PrimitiveType.Triangles, 0, 36);//36个顶点
